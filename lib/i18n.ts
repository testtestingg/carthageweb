...
const en = {
  ...
  product: {
    ...
    priceOnRequest: "Price on Request",
    requestQuote: "Request a Quote",
    priceOnRequestNote: "Pricing depends on specification and volume. Tell us what you need and we will come back with a quote.",
    addToCart: "Add to Cart",
...
const fr: Dictionary = {
  ...
  product: {
    ...
    priceOnRequest: "Prix sur demande",
    requestQuote: "Demander un devis",
    priceOnRequestNote: "Le prix dépend des spécifications et du volume. Dites-nous ce qu'il vous faut et nous vous enverrons un devis.",
    addToCart: "Ajouter au panier",
...
const de: Dictionary = {
  ...
  product: {
    ...
    priceOnRequest: "Preis auf Anfrage",
    requestQuote: "Angebot anfordern",
    priceOnRequestNote: "Der Preis richtet sich nach Spezifikation und Menge. Sagen Sie uns, was Sie brauchen, und wir melden uns mit einem Angebot.",
    inclTax: "inkl. MwSt.",
    addToCart: "In den Warenkorb",
